...
logit(fv) == lp
```
> We can see that the linear predictors are the same as the logit transformed fitted values; and, the inverse logit transformed linear predictors are the same as the fitted values. 
