...
1) Describe the dataset, such that someone who happened upon this dataset could understand the variables and what they contain  
    ...
    > The politeness dataset contains the results of ******experiments???***** and contains the following columns
    > subject: participant id
    > gender: participant's gender
    > scenario: the experimental scenario from 1 to 7
    > attitude: either 'inf' if the particpants are speaking informally or 'pol' if the participants are speaking in a polite manner
    > total_duration: time in **unit** of interaction
    > f0mn: mean frequency of the participant's speech
    > hiss_count: number of times the participants made a hissing sound
    >
    > The gender, scenario and attitude variables should be encoded as factors as they are categorical and do not have continuous relationship between variable values.
