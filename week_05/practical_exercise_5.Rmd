...
How does PAS affect accuracy together with target duration? 
PAS together with target duration, the accuracy 
comment on the behaviour at targetframes=0, is that behaviour reasonable? 
...
```{r}
m7 <- glmer(correct ~ pas * target.frames + (target.frames | subject), data = exp1, family = binomial(link = "logit")
summary(m7)
```
### Exercise 6, part 2
